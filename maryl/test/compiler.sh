...
./glados build test/test_files/add.mrl
./glados run out.masm
output=$(echo $?)
if [ "$output" == "8" ]; then
...
./glados build test/test_files/mixupadd.mrl
./glados run out.masm
output=$(echo $?)
if [ "$output" == "6" ]; then
...
./glados build test/test_files/ifbasic.mrl
./glados run out.masm
output=$(echo $?)
if [ "$output" == "2" ]; then
...
./glados build test/test_files/elseifelse.mrl
./glados run out.masm
output=$(echo $?)
if [ "$output" == "3" ]; then
...
./glados build test/test_files/basiclist.mrl
./glados run out.masm
output=$(echo $?)
if [ "$output" == "4" ]; then
...
./glados build test/test_files/print.mrl
...
./glados build test/test_files/ops.mrl
./glados run out.masm
output=$(echo $?)
if [ "$output" == '1' ]; then
...
./glados build test/test_files/ternary.mrl
./glados run out.masm
output=$(echo $?)
if [ "$output" == '4' ]; then
...
./glados build test/test_files/fact.mrl
./glados run out.masm
output=$(echo $?)
if [ "$output" == '120' ]; then
...
./glados build test/test_files/loop.mrl
output=$(./glados run out.masm | tr -d '\n')
...
./glados build test/test_files/closeevalerror.mrl
output=$(./glados run out.masm | tr -d '\n')
...
./glados build test/test_files/builtin.mrl
output=$(./glados run out.masm | tr -d '\n')
